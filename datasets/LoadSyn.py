...
class LoadSyn(InMemoryDataset):
    """ Load node classification dataset for explanation
    support: BA_Shapes; Tree_Grid; Tree_Cycle;
    ...
    def __init__(self, name, 
        ...
        self.name = name
        super().__init__('./datasets/Load{}'.format(name), transform, pre_transform)
    ...
    def download(self):
        ...
        data = data_utils.load_dataset(self.name)
...
if __name__ == "__main__":
    ipdb.set_trace()
    data = LoadSyn('BA_shapes')
    print('data synthesized')

    data = LoadSyn('Tree_cycle')
    print('data synthesized')