          ...
          for aligner in ${aligners[*]}
            do
              for align_weight in ${align_weights[*]}
                do
                  #CUDA_VISIBLE_DEVICES=0 python explain_consistency.py --nlayer=3 --dataset=$dataset --log --edge_size=$edge_size --explainer=$expl --expl_loss=$expl_loss --align_emb --aligner=$aligner --align_weight=$align_weight --lr=$lr --epochs=$epochs --edge_ent=$edge_ent --directional #--align_with_grad 
        ...
        do
          ...
          for aligner in ${aligners[*]}
            do
              for align_weight in ${align_weights[*]}
                do
                  #CUDA_VISIBLE_DEVICES=2 python explain_consistency.py --nlayer=3 --dataset=$dataset --log --edge_size=$edge_size --explainer=$expl --expl_loss=$expl_loss --align_emb --aligner=$aligner --align_weight=$align_weight --lr=$lr --epochs=$epochs --edge_ent=$edge_ent --directional #--align_with_grad 
