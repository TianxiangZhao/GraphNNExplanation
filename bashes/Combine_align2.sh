  ...
  do
    for expl_loss in ${expl_losses[*]}
      ...
      for aligner_combine_weight in ${aligner_combine_weights[*]}
        do
          CUDA_VISIBLE_DEVICES=2 python explain_GNN.py --log --nlayer=3 --dataset=$dataset --edge_size=$edge_size --explainer=$expl --expl_loss=$expl_loss --lr=$lr --epochs=$epochs --edge_ent=$edge_ent --directional --aligner_combine_weight=$aligner_combine_weight
            ...
            do
              for align_weight in ${align_weights[*]}
                do
                  ...
                  CUDA_VISIBLE_DEVICES=2 python explain_GNN.py --log --nlayer=3 --dataset=$dataset --edge_size=$edge_size --explainer=$expl --expl_loss=$expl_loss --aligner=$aligner --align_weight=$align_weight --align_emb --lr=$lr --epochs=$epochs --edge_ent=$edge_ent --directional --aligner_combine_weight=$aligner_combine_weight
...
for edge_size in ${edge_sizes[*]}
  do
    for expl_loss in ${expl_losses[*]}
      ...
      for aligner_combine_weight in ${aligner_combine_weights[*]}
        do
          CUDA_VISIBLE_DEVICES=2 python explain_GNN.py --log --nlayer=3 --dataset=$dataset --edge_size=$edge_size --explainer=$expl --expl_loss=$expl_loss --directional --datatype=graph --batch_size=32 --lr=$lr --epochs=$epochs --edge_ent=$edge_ent --aligner_combine_weight=$aligner_combine_weight
